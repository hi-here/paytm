...
<body>	
 ...
 <div class="instructions">
        <h4>Find Box And Win Paytm Cash</h4>
         </div>
<center>
...
<div class="container">
        <span id="today">
						...
						if ("vibrate" in navigator)             
							...
							var vibr = 0;
						</script></span><div class="instructions"> Find Box and Win <br> Upto
2500 RS Paytm Cash You Can <br><span class="bounce">↓</span><span class="bounce">↓</span>Try Upto 1 Times Only</b><span class="bounce">↓</span><span class="bounce">↓</span>
		</div>	

		<br><center style="color: #232F3E;margin: 5px 0px 5px">Remaining attempts: &nbsp; <span class="word">1</span><span class="word">0</span></center>
<script>
 ...
 if(start==1)
 {
	...
	document.getElementById("hsecs").innerHTML = secs;
        ...
        <div id="boxes" class="boxes">
            <div id="0"><img src="new_gift.png" class="try">
            </div>
            <div id="1"><img src="new_gift.png" class="try">
            </div>
            <div id="2"><img src="new_gift.png" class="try">
            </div>
            <div id="3"><img src="new_gift.png" class="try">
            </div>
            <div id="4"><img src="new_gift.png" class="try">
            </div>
            <div id="5"><img src="new_gift.png" class="try">
            </div>
            <div id="6"><img src="new_gift.png" class="try">
            </div>
            <div id="7"><img src="new_gift.png" class="try">
            </div>
            <div id="8"><img src="new_gift.png" class="try">
            </div>
            <div id="9"><img src="new_gift.png" class="try">
            </div>
            <div id="10"><img src="new_gift.png" class="try">
            </div>
            <div id="11"><img src="new_gift.png" class="try">
            </div>
        </div>
        <script>
        var count = 1;
		...
		{ 
		  $( ".try" ).click(function() {
            $( this ).attr('src',"new_gift_empty.png");
				changeWord();
				if(count < 1)
					count++;					
				else
				{
					...
					$( this ).attr('src',"new_gift_win2.png");
					start = 0;
					setTimeout(function() 
					{
    ...
    <div class="sweet-alert" id="modal03">
        <h4 style="font-size: 18px; margin-top: 10px; color="red"">Congratulations!<br/>2500 Rs Paytm is reserved</h4>
  <hr class="hr-primary" />
        <p><font style="font-size: 20px;" color="green">(1). </font><i class="fa fa-inr" style="font-size:20px;color:green;"></i><font style="font-size: 20px;" color="green">1000</font></p>
        <p><font style="font-size: 20px;" color="green">(2). </font><i class="fa fa-inr" style="font-size:20px;color:green;"></i><font style="font-size: 20px;" color="green">800</font></p>
        <p><font style="font-size: 20px;" color="green">(3). </font><i class="fa fa-inr" style="font-size:20px;color:green;"></i><font style="font-size: 20px;" color="green">700</font></p>
        <hr class="hr-primary" />
                <p><font style="font-size: 20px;" color="green">(Total).</font><i class="fa fa-inr" style="font-size:20px;color:green;"></i><font style="font-size: 20px;" color="green">2500</font></p>

        <hr class="hr-primary" />
        
        <br/><div style="text-align: left">
        <p><b>1. success. paytm cash of rs 2500 will be credited in your account within 24 hours after successfull completion of all step..</b></p>
  
           <center> <div class="sa-confirm-button-container">
            <button onclick="window.location='claim.php';" >Caim Now</button>
            </div>	</center>
        </div>
